...
userSchema.pre('save', async function (next) {
  //Only ryn this function if password was actually modified
...
userSchema.pre('save', function (next) {
  ...
  // - 1000 because sometimes the database can take a bit longer to save document to database then the jwt will be sign before the passwordChangedAt
